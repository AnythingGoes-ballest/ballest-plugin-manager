"""Measurement session: launches the game, optionally opens a map, then sends host test-channel commands.
    ...
    python tools/dev_session.py commands.txt [--map Map_LethTrial_01] [--keep] [--force]
...
Prints every host.log line produced. Never touches a game the user is running (unless --force).
"""
import argparse
import os
import re
